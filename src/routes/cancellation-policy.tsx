...
function CancellationPolicy() {
  ...
  return <PolicyPage eyebrow="Booking policies" title="Cancellation policy" intro="Cancellation terms can vary by tour, accommodation, restaurant, and provider. The policy shown on the listing at the time of booking applies to your reservation." custom={settings?.policyCancellation} sections={[
