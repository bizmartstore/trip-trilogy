...
function TermsOfService() {
  return <PolicyPage eyebrow="Marketplace agreement" title="Terms of service" intro="By using Nexora, you agree to these terms and to the specific conditions shown by each travel, accommodation, or dining provider." sections={[
